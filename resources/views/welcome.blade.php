                    ...
                    <div class="sm:text-center lg:text-left">
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="rounded-full shadow">
                                ...
                                @auth
                                <a href="{{ url('/dashboard') }}"
                                    class="flex w-full items-center justify-center rounded-full bg-blue-600 px-8 py-3 text-base font-medium text-white hover:bg-blue-700 md:px-10 md:py-4 md:text-lg">
                                    Dashboard
                                </a>
                                @else
                                <a href="{{ route('login') }}"
                            ...
                            <div class="mt-3 sm:ml-3 sm:mt-0">
                                <a href="#features"
                                    class="flex w-full items-center justify-center rounded-full bg-blue-100 px-8 py-3 text-base font-medium text-blue-700 hover:bg-blue-200 md:px-10 md:py-4 md:text-lg">
            ...
            <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="pt-6">
                    <div class="flow-root rounded-lg bg-white px-6 pb-8">
                        <div class="-mt-6">
                            <div class="inline-flex items-center justify-center rounded-full bg-blue-600 p-3 shadow-lg">
