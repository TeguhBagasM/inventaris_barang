        ...
        <div class="card shadow-lg ">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    ...
                    <p>Sesuaikan opsi tampilan dashboard di sini.</p>
                </div>
            ...
            <div class="card-body pt-sm-3 pt-0">
                <!-- Sidebar Backgrounds -->
                <div>
                    <h6 class="mb-0">Pilih Warna Sidebar</h6>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <p class="text-sm">Pilih antara dua tipe sidebar yang berbeda.</p>
                </div>
                <div class="d-flex">
                ...
                <p class="text-sm d-xl-none d-block mt-2">Perubahan tipe sidebar hanya berlaku di tampilan desktop.</p>
                <!-- Navbar Fixed -->
                <div class="mt-3">
