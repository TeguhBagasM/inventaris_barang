                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    ...
                                    <p class="mb-0">Silakan login menggunakan email dan kata sandi Anda.</p>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('login') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <x-text-input placeholder="Email" id="email"
                                                class="block w-full form-control" type="email" name="email"
                                                :value="old('email')" required autofocus autocomplete="username" />
                                        </div>
                                        <label>Password</label>
                                        <div class="mb-3">
                                            <x-text-input placeholder="Password" id="password"
                                                class="block w-full form-control" type="password" name="password"
                        ...
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                                    style="background-image:url('../assets/img/bg_smkn2.jpg')"></div>
                            </div>
                        </div>
                    </div>
                </div>
