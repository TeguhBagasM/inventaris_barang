                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="">Data Permintaan Barang</h4>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive p-0">
                            @if ($details->isEmpty())
                                <div class="d-flex flex-column align-items-center my-4">
                                    ...
                                    <h5 class="text-muted">Belum ada data permintaan</h5>
                                </div>
                            @else
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-dark text-sm font-weight-bolder">Tanggal Permintaan</th>
                                    ...
                                    <tbody>
                                        @foreach ($details as $permintaan)
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="text-secondary text-sm font-weight-bold ps-2">
                                                        {{ \Carbon\Carbon::parse($permintaan->tanggal_minta)->translatedFormat('l, d F Y') }}
                                                    </h6>
                                                </td>
                                                <td>
                                                    <h6 class="text-secondary text-sm font-weight-bold ps-2">
                                                        {{ $permintaan->detailBarangKeluars->sum('jumlah') }} Barang
                                                    </h6>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('permintaan.detail.spesifik', $permintaan->id) }}" 
