                            ...
                            <form action="{{ route('ruang.update', $ruang->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('ukuran') is-invalid @enderror" 
                                           ...
                                           value="{{ old('ukuran', $ruang->ukuran) }}" required>
                                    @error('ukuran')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('kondisi') is-invalid @enderror" 
                                        ...
                                        <option value="Baik" {{ old('kondisi', $ruang->kondisi) == 'Baik' ? 'selected' : '' }}>Baik</option>
                                        <option value="Rusak Ringan" {{ old('kondisi', $ruang->kondisi) == 'Rusak Ringan' ? 'selected' : '' }}>Rusak Ringan</option>
                                        <option value="Rusak Berat" {{ old('kondisi', $ruang->kondisi) == 'Rusak Berat' ? 'selected' : '' }}>Rusak Berat</option>
                                    </select>
                                    @error('kondisi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('peruntukkan') is-invalid @enderror" 
                                           name="peruntukkan" id="peruntukkan" 
                                           value="{{ old('peruntukkan', $ruang->peruntukkan) }}" required>
                                    @error('peruntukkan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                              name="keterangan" id="keterangan" rows="3">{{ old('keterangan', $ruang->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
